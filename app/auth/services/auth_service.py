...
class AuthService:
    ...
    def __init__(self, repository: AuthRepositoryProtocol | None = None) -> None:
        ...
        Args:
            repository: Repository interface used for future Stored Procedure-backed
    ...
    def create_access_token_response(
        ...
        Args:
            subject: Stable subject identifier for the token.
            additional_claims: Optional non-reserved claims to include.

        Returns:
            AccessTokenResponse: Token DTO for the API layer.
        """
    ...
    def authenticate_oauth_user(
        ...
        Args:
            ...
            identity: Normalized provider identity payload.

        Returns:
            AccessTokenResponse: JWT access token response for the authenticated
                user.
    ...
    def build_authenticated_user(self, token: str) -> AuthenticatedUser:
        ...
        Returns:
            AuthenticatedUser: Typed user context for downstream dependencies.
        """
