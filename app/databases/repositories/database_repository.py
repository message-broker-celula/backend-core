"""Database management repository adapter.
...
repository implementation, mirroring `app.auth.repositories.auth_repository`.
"""
...
class DatabaseManagementRepository(SQLServerRepository):
    """Default Stored Procedure-backed database lifecycle repository."""
